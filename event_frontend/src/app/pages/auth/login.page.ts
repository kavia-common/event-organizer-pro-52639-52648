  ...
  template: `
    <div class="auth">
      <div class="card">
        ...
        <div class="sub">Sign in to manage your events.</div>
...
export class LoginPage {
  ...
  async submit(): Promise<void> {
    ...
    try {
      ...
      this.notifications.push('success', 'Signed in', 'Welcome back.');
      await this.router.navigateByUrl('/app');
    } catch (e: any) {
      this.notifications.push('error', 'Sign in failed', e?.message ?? 'Please try again.');
    } finally {
      this.busy.set(false);
    }
  }
